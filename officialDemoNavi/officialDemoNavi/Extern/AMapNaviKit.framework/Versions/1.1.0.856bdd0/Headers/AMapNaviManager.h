 ...
 */
@property (nonatomic, assign) id<AMapNaviManagerDelegate> delegate;
...
/*!
 @brief 手动刷新路况信息，调用后会立即触发一次光柱信息请求，并刷新路况光柱。（只适用于驾车导航）
 */
 ...
 */
- (void)AMapNaviManager:(AMapNaviManager *)naviManager didUpdateNaviInfo:(AMapNaviInfo *)naviInfo;
