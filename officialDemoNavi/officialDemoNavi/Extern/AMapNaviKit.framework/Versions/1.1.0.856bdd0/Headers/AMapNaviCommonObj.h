...
typedef NS_ENUM(NSInteger, AMapNaviCalcRouteState)
{
    ...
    AMapNaviCalcRouteStateUnknowError = 13,         //13 未知错误
};
...
/*!
 @brief 经纬度
 */
@interface AMapNaviPoint : NSObject<NSCopying>
...
@interface AMapNaviPointBounds : NSObject<NSCopying>
...
/*!
 @brief 导航段信息类
 */
@interface AMapNaviGuide : NSObject
